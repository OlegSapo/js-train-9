...
function findElementGreaterThan(arr, num) {
  ...
  if (!Array.isArray(arr)) {
    ...
    let firstElem = arr.find((elem) => elem > num);
    // return elem > num ? elem : "Числа, яке задовільняе умову не знайдено";
    if (firstElem !== undefined) {
      return console.log(firstElem);
    } else {
      return console.log("Числа, яке задовільняе умову не знайдено");
    }
  }
}
...
function findIndexByProperty(arr, name) {
  ...
  if (!Array.isArray(arr)) {
    ...
    let firstIndex = arr.findIndex((elem) => elem.name === name);
    if (firstIndex !== -1) {
...
function findLastEvenNumber(arr) {
  ...
  if (!Array.isArray(arr)) {
    ...
    let firstLast = arr.findLast((elem) => elem % 2 === 0);
    if (firstLast !== undefined) {
      return console.log(firstLast);
    } else {
      return console.log("Парних чисел не знайдено");
    }
  }
}
...
function getSubArrayAndConvertToString(arr, startIdx) {
  ...
  if (!Array.isArray(arr)) {
    ...
    let subArr = arr.slice(startIdx).join(" ");
    return subArr;
  }
}
...
function getPositiveArrayValues(arr) {
  ...
  if (!Array.isArray(arr)) {
    ...
    let arrPlus = arrValues.filter((elem) => elem > 0);
    return console.log(arrPlus);
  }
}
...
function sumAndPrint(arr) {
  ...
  if (!Array.isArray(arr)) {
    ...
    let sum = arr.reduce((accum, curVal) => accum + curVal);
...
function flattenSquareAndFilter(arr, threshold) {
  ...
  if (!Array.isArray(arr)) {
    ...
    let arrNew = arr.flat(3);
    let arrNewDouble = arrNew.map((elem) => elem ** 2);
    let result = arrNewDouble.filter((elem) => elem > threshold);
    return console.log(result);
  }
}
...
function getLastElementsSumAndPrint(arr, n) {
  ...
  if (!Array.isArray(arr)) {
    ...
    let lastElems = arr.slice(-n);
    let sum = lastElems.reduceRight((accum, curVal) => accum + curVal);
    lastElems.forEach((elem) => console.log(elem));
...
function wordLengths(arr) {
  ...
  if (!Array.isArray(arr)) {
    ...
    let len = arr.map((elem) => elem.toString().length);
    console.log(len);
  }
}
...
function findLongestWord(arr) {
  ...
  if (!Array.isArray(arr)) {
    ...
    let result = arr.reduce((len, elem, index, array) => {
      // console.log(len, elem.length, elem);
      return elem > len ? elem : len;
    });
    console.log(result);
  }
}
...
function findDuplicateElements(arr) {
  ...
  if (!Array.isArray(arr)) {
    ...
    let duplicateElems = arr.filter((elem) => {});
  }
}
